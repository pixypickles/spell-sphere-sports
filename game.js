...
function updateOrientation(){
  ...
  document.body.classList.toggle('forcePortraitPlay', !landscape&&forcePortraitPlay);
}
window.addEventListener('resize', updateOrientation, {passive:true});
window.addEventListener('orientationchange', ()=>setTimeout(updateOrientation,120), {passive:true});
document.addEventListener('click',e=>{
  if(e.target&&e.target.id==='portraitContinueBtn'){
...
function drawUnit(u){
  // v3.08: genuine frog mages never use human headwear/outfit head pieces.
  ...
  if(u.fairyActive){
    ...
    // v3.08 fairy appearance: human/fairy face, blue hair, twin buns, point eyes, ▼ mouth
    g.fillStyle='#f2cf72';
